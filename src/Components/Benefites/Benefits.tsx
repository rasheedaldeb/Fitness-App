...
const Benefites = ({ setSelectedPage }: Props) => {
  return (
        ...
        <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
          ...
          <div>
            ...
            <div className="relative mt-16">
              <div className="before:absolute before:right-40 before:-bottom-20 before:z-[01] before:content-[url('@/assets/Sparkles.png')]"></div>
