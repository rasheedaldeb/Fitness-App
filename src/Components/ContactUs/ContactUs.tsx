        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              method="POST"
              action="https://formsubmit.co/844c881f314ebd6e53c681ead1969fc0"
            >
              <input
                type="text"
              ...
              {errors.name && (
                <p className="text-primary-500 mt-1">
                  ...
                  {errors.name.type === "maxLengith" &&
                    "Max lengith is 100 char."}
                </p>
              )}
              <input
                type="text"
              ...
              {errors.email && (
                <p className="text-primary-500 mt-1">
                  ...
                  {errors.email.type === "pattern" && "Invaled email address."}
                </p>
              )}
              <textarea
                rows={4}
              ...
              {errors.message && (
                <p className="text-primary-500 mt-1">
                  {errors.message.type === "required" &&
                    "This field is required."}
                  {errors.message.type === "maxLengith" &&
                    "Max lengith is 2000 char."}
                </p>
              )}
              <button
                type="submit"
